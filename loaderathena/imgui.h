...
namespace ImGui
{
    ...
    IMGUI_API ImU32         GetColorU32(const ImVec4& col, float alpha_mul = 1.0f);
    ...
    IMGUI_API bool         CustomButton(const char* label, const char* icon, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Page(bool selected, const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags);
    IMGUI_API bool          icon_box(ImTextureID id_image, ImVec2 size, ImVec2 icon_size, ImU32 color_icon);
    IMGUI_API bool          Selector(bool selected, ImTextureID image, const char* label, const ImVec2& size_arg);
    IMGUI_API void          status_list(const char* name, const char* description, const ImVec2& size, ImDrawFlags flags);
